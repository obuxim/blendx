...
import { bigint, boolean, foreignKey, index, integer, jsonb, numeric, pgEnum, pgTable, primaryKey, text, timestamp, uuid, varchar } from "drizzle-orm/pg-core";
...
export const order_items = pgTable("order_items", {
  ...
  foreignKey({ name: "order_items_order_id_fkey", columns: [t.order_id], foreignColumns: [orders.id] }).onDelete("cascade").onUpdate("no action"),
]);
