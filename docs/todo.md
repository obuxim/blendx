...
- [ ] A guide page for `@blendx/react` in `docs/guide/`, once N.2 and N.3 settle invalidation and form errors: creating the client, queries and mutations, keys, errors. (Found in N.1b.)
