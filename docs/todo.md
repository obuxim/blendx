...
- [ ] P16.6 later in the review and the docs: the review lists `later` where a hook sets it; the guide (hooks; deployment: running the worker), a cookbook pattern and the CLAUDE.md templates. Done: review tests, and every doc link resolving.
