...
**Consequences:** P15.2 (the SQLSTATE mapping) and P15.3 (the derived rules, with a new rule id, a conformance case, and OpenAPI and the review describing the forms).
